...
/**
 * DAO-Klasse für den Zugriff auf {@link Trainer}-Entitäten.
 * Diese Klasse erweitert {@link BaseDAO} und bietet Methoden zur Suche
 * nach Vorname, Nachname und Aktivitätsstatus von Trainern.
 * 
 * @author Marko
 */
public class TrainerDAO extends BaseDAO<Trainer> {
    ...
    /**
     * Konstruktor, der die {@link Trainer}-Klasse an den generischen DAO übergibt.
     */
    public TrainerDAO() {
        super(Trainer.class);
    }
    ...
    /**
     * Sucht {@link Trainer}-Einträge anhand des Vornamens (case-insensitive, Teilstring möglich).
     *
    ...
    /**
     * Sucht {@link Trainer}-Einträge anhand des Nachnamens (case-insensitive, Teilstring möglich).
     *
     ...
     *
     * @param aktiv {@code true} für aktive Trainer, {@code false} für inaktive Trainer
     * @return Liste der passenden {@link Trainer}-Objekte
     */
